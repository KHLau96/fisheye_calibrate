...
int main()
{
    ...
    **/
    ...
    cv::Size board_size = cv::Size(9,6);            //定标板上每行、列的角点数
...
//        cv::Mat image = imread("./img"+imageFileName);
        cv::Mat image = imread("/home/samlau/CLionProjects/fisheye_calibrate/img"+imageFileName);
    ...
    *************************************************************************/
    if (1)
    {
        ...
        cout<<"TestImage ..."<<endl;
        Mat distort_img = imread("/home/samlau/CLionProjects/fisheye_calibrate/a.jpg",1);
        Mat undistort_img;
        ...
        imwrite("/home/samlau/CLionProjects/fisheye_calibrate/output.jpg",undistort_img);
        cout<<"保存结束"<<endl;
    }
